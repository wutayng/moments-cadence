...
pub contract MomentsMarket {
    ...
    init () {
        self.CollectionStoragePath = /storage/MomentsMarketContractAddress_momentsMarketCollection
        self.CollectionPublicPath = /public/MomentsMarketContractAddress_momentsMarketCollection
    }
}